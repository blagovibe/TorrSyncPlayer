...
func main() {
	...
	if config.UseTLS {
		...
		// Note: auto-generated cert files are cleaned up immediately in configureTLS
		// User-provided certs are preserved
	}
...
func configureTLS(config *Config) (_ *tls.Config, retErr error) {
	...
	// If auto-generated, clean up temp files immediately after loading into memory
	if config.autoGenerated {
		logger.Debug("Cleaning up auto-generated TLS cert files after loading into memory")
		_ = os.Remove(config.TLSCert)
		_ = os.Remove(config.TLSKey)
		config.TLSCert = ""
		config.TLSKey = ""
